...
namespace engine.Properties {
	...
	internal class Resources {
		...
		/// <summary>
		///   Looks up a localized string similar to var JsonToRoom=function(jsnStr, rm) {
		///	var z, z2
		...
		///};.
		/// </summary>
		internal static string sys_js_JsonToRoom {
			get {
				return ResourceManager.GetString("sys_js_JsonToRoom", resourceCulture);
			}
		}
	}
}
